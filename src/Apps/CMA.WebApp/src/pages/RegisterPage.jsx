  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 right-1/3 w-96 h-96 bg-primary/6 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/3 w-80 h-80 bg-gold/4 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[380px] mx-4 animate-fade-in">
        ...
        <div className="bg-surface rounded-2xl border border-border shadow-[0_24px_80px_rgba(0,0,0,0.6)] overflow-hidden">
          ...
          <div className="p-7">
            <h2 className="font-display text-lg font-semibold text-text-primary mb-0.5">Create account</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
              <div>
                ...
                <input type="text" placeholder="Nguyen Van A" autoComplete="name"
                  {...register('fullName')} className={fieldCls} />
